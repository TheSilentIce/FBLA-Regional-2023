            ...
            <div className="gala-banner">
                ...
                <div className="gala-content">
                    ...
                    <p>
                        ...
                        opportunity to join forces with other compassionate individuals and make
                        a real difference in the lives of those affected by disasters and
                        emergencies. The Red Cross Gala will be a night of elegance and inspiration,
                        featuring a red carpet arrival, cocktail reception, delicious dinner, and entertainment.
                        Guests will hear from a keynote speaker and contribute to the Red Cross's vital work
                        through a live auction, fund-a-need, and silent auction. The event will leave attendees 
                        feeling moved and motivated to support the Red Cross's mission.
                    </p>
                </div>
            </div>
            <>
                ...
                <li>
                    <GalaPromotionBenefits title="Provide immediate relief" text="Your contribution will help us offer
                    food, shelter, emotional support, and other essential services to
                    individuals and families impacted by disasters."/>

                </li>
                <li>
                    <GalaPromotionBenefits title="Ensure a safe blood supply" text="Funds raised at the gala will
                    support our blood collection efforts, ensuring a readily available
                    supply for hospitals and patients in need."/>
                </li>
                <li>
                    <GalaPromotionBenefits title="Prepare communities" text="Your generosity will allow us to educate
                    individuals and communities on disaster preparedness, reducing the
                    impact of future emergencies and saving lives."/>
                </li>
                <li>
                    <GalaPromotionBenefits title="Empower volunteers" text="Contributions will support our volunteer
